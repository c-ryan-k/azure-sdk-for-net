...
namespace Microsoft.DigitalTwins
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<AzureDigitalTwinsManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AzureDigitalTwinsManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.DigitalTwins/operations").ToString();
